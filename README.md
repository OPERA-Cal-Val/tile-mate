...
+ Height above nearest drainage (distributed and generated by ASF) in 2021 derived from the Copernicus GLO-30 DEM: https://glo-30-hand.s3.us-west-2.amazonaws.com/readme.html
  + The tiles are the same 1 degree by 1 degree tiles as the Copernicus GLO-30 DEM served by [`dem-stitcher`](https://github.com/ACCESS-Cloud-Based-InSAR/dem-stitcher)
  + See ASF's [notebook](https://github.com/asjohnston-asf/agu-2022-notebooks/blob/main/hand-notebook.ipynb) and their [tool](https://github.com/HydroSAR/HydroSAR/blob/develop/src/hydrosar/hand/prepare.py) to do the exact same thing
...
+ UMD ocean mask indicating the (floored) distance in km from land to ocean up to a maximum of 4: https://console.cloud.google.com/storage/browser/earthenginepartners-hansen/OceanMask
